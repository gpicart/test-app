...
import { RickAndMortyFormOnChange } from './rick-and-morty-form-on-change';
...
const setup = () => {
  /* Swap between these to see how all tests works just fine even when we changed the
   implementation */
  /* const utils = render(<RickAndMortyFormOnChange />); */
